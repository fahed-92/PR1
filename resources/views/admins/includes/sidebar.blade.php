    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item active"><a href=""><i class="la la-mouse-pointer"></i><span
                        class="menu-title" data-i18n="nav.add_on_drag_drop.main">Main Dashboard </span></a>
            </li>

            {{--            this elction program space              --}}
            <li class="nav-item active ">
                <a href=""><i class="la la-home"></i>
                    ...
                    <span class="badge badge badge-info badge-pill float-right mr-2">
                        {{App\ElectionProgram::count()}}
                    </span>
                </a>
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" href="{{route('admin.electionprog')}}"
                                          data-i18n="nav.dash.ecommerce">
                            Show All
                        </a>
                    </li>
                    <li>
                        <a class="menu-item" href="{{route('admin.electionprog.create')}}"
            ...
            <li class="nav-item  active ">
                ...
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" href="{{ route('admin.candidate') }}"
                           data-i18n="nav.dash.ecommerce">
                            Show All
                        </a>
                    </li>
